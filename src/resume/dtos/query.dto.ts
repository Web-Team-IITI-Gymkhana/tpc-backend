...
export class ResumeQueryDto {
  ...
  @NestedObject({ type: FilterResumesDto, optional: true })
  filterBy?: FilterResumesDto;

  @NestedObject({ type: OrderResumesDto, optional: true })
  orderBy?: OrderResumesDto;
}
